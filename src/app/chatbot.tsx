...
function ChatbotIframe() {
    ...
    return (
        <div
            className={`fixed bottom-4 right-4 md:bottom-5 md:right-5 z-50 cursor-pointer flex flex-col ${isOpen ? "w-[350px] h-[600px]" : "w-16 h-16 md:w-20 md:h-20"}`}
        ...
        >
            ...
            {!isOpen && (
                <div className="w-17 h-17 md:w-20 md:h-20 rounded-full overflow-hidden flex items-center justify-center ">
                    <img src="https://github.com/ledskard/7onsexy-catalog-frontend.git" alt="Chat Icon" className="w-full h-full object-cover" />
                </div>
            )}
